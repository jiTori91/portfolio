window.onload = function() {
    var container = document.getElementById('mapGM');
    var options = {
        center: new daum.maps.LatLng(37.40187154209946, 127.0614573802911 ),
        level: 2
    };
    ...
    var markerPosition  = new daum.maps.LatLng(37.40187154209946, 127.0614573802911 ); 
    ...
    //두번째 맵
      ...
      var container2 = document.getElementById('mapDT');
    var options2 = {
        center: new daum.maps.LatLng(37.88759746927078, 127.72626149624688),
        level: 2
    };
    ...
    var markerPosition2  = new daum.maps.LatLng(37.88759746927078, 127.72626149624688); 
    ...
    // 세번째 맵
     ...
     var container3 = document.getElementById('mapME');
   var options3 = {
       center: new daum.maps.LatLng(37.88759746927078, 127.72626149624688),
       level: 2
   };
   ...
   var markerPosition3  = new daum.maps.LatLng(37.88759746927078, 127.72626149624688); 
